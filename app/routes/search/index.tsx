...
export default function Search() {
  ...
  return (
    <div className="mx-auto w-full pt-18 pb-16 lg:pt-25">
      <Tabs defaultValue={tab} value={tab} onValueChange={handleTabChange}>
        <div className="mx-auto flex w-full justify-center bg-gray-100">
          <TabsList className="w-full max-w-[1480px] overflow-auto">
        ...
        <div className="mx-auto flex w-full max-w-[1480px] justify-center p-4 md:pt-20">
          <TabsContent value="all" className="flex flex-col gap-20">
            <AllSearchResults query={query} />
          </TabsContent>
          <TabsContent value="meeting" className="flex flex-col gap-20">
            <MeetingSearchResults query={query} />
          </TabsContent>
          <TabsContent value="guide" className="flex flex-col gap-20">
            <GuidebookSearchResults query={query} />
          </TabsContent>
          <TabsContent value="host" className="flex flex-col gap-20">
