...
export default function ValueSection() {
  return (
    <div className="mt-40 w-full bg-gray-100">
      <div className="mx-auto max-w-[1448px] py-24 text-center">
        <Text variant="H2_Semibold">비빔이 추구하는 가치</Text>
        <Text variant="T4_Regular" color="gray-500" className="mt-2">
          연경망을 통한 따뜻한 사회로
        </Text>

        <div className="mx-auto mt-12 grid max-w-[1177px] grid-cols-1 gap-4 px-4 sm:grid-cols-2 md:grid-cols-3">
